...
public class EventReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.getAction().equals("itu.dd.client.NEW_MOOD_READING")) {
			m.arg1 = EVENT_MOOD_READING;
		} else if (intent.getAction().equals("itu.dd.client.NEW_LOCATION_CHANGE")) {
			m.arg1 = EVENT_LOCATION_CHANGE;
		} else if (intent.getAction().equals(
				"android.intent.action.NEW_OUTGOING_CALL")) {
			m.arg1 = EVENT_OUTGOING_CALL;
		} else if (intent.getAction().equals("itu.dd.client.NEW_INCOMING_CALL")) {
			m.arg1 = EVENT_INCOMING_CALL;
		} else if (intent.getAction().equals("itu.dd.client.NEW_OUTGOING_SMS")) {
