...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(final SQLiteDatabase db) {
		try{
			...
			db.execSQL("CREATE TABLE " + DBHelper.TABLE_EVENT + " (id INTEGER PRIMARY KEY AUTOINCREMENT, trip INTEGER NOT NULL, dateTime LONG NOT NULL, longitude DOUBLE, latitude DOUBLE, altitude LONG, mood SMALLINT, sender VARCHAR, reciever VARCHAR, message VARCHAR, online BOOLEAN);");
